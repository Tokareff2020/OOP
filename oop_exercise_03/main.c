...
public:
    ...
    void read() {
        cout << "Ввод квадрата. Стороны квадрата параллельны осям координат. Вершины прямоугольника перечисляются следующим образом: " << "\n";
        cout << "  B----------C" << "\n";
        cout << "  |          |" << "\n";
        cout << "a |          |" << "\n";
        cout << "  |          |" << "\n";
    ...
    void getCentre() {
        centre.x = point1.x + a / 2;
        centre.y = point1.y + a / 2;
        cout << "Геометрический центр квадрата имеет координаты: (" << centre.x << "," << centre.y << ")\n";;
        return;
    }

    void write() {
        cout << "Вывод квадрата. Вершины квадрата перечисляются следующим образом: " << "\n";
        cout << "  B----------C" << "\n";
        cout << "  |          |" << "\n";
        cout << "a |          |" << "\n";
        cout << "  |          |" << "\n";
        ...
        cout << "Координаты точки A: (" << point1.x << "," << point1.y << ")\n";
        cout << "Координаты точки B: (" << point1.x << "," << point1.y + a << ")\n";
        cout << "Координаты точки C: (" << point1.x + a << "," << point1.y + a << ")\n";
        cout << "Координаты точки D: (" << point1.x + a << "," << point1.y << ")\n";
    }
};
...
int main() {
    ...
    cout << "Токарев Михаил Станиславович \n";
    cout << "Лабораторная работа 3. \n";
    cout << "Вариант 4: Разработать классы согласно варианту задания, классы должны  наследоваться от базового класса Figure. Вариант реализован для Прямоугольника, трапеции и квадрата. \n";
    cout << "\n";
    int n = 0;
